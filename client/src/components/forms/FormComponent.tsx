...
const FormComponent = () => {
    ...
    return (
        <div className="flex w-full max-w-[500px] flex-col items-center justify-center gap-6 p-6 bg-gradient-to-b from-blue-700 from-80% to-pink-500 from-20% rounded-lg shadow-lg">
